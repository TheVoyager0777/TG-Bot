"""Version metadata for phantom-infiniproxy."""
    ...
    for root, dirs, files in os.walk(_HERE):
        ...
        for name in files:
            if not (name.endswith(".py") or name.endswith(".html")
                    or name.endswith(".js") or name.endswith(".md")
